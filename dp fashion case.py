...
ROWAN_Max_Wait = 60
ROWAN_Min_Window = 20
Fashion_Case_Max_Wait = 100
Fashion_Min_Window = 60
...
movements_to_try = [
    [LL,L,L,L,L,L,L,L,L,L,L,L,L,L,L,L,L,L,U,U,U,U,U,U,U,U,U,U,U,U,U,U,UU],
    [LL,L,L,L,L,L,L,L,L,L,L,L,L,L,L,L,U,L,L,U,U,U,U,U,U,U,U,U,U,U,U,U,UU],
    [LL,L,L,L,L,L,L,L,L,L,L,L,L,L,L,L,U,U,L,L,U,U,U,U,U,U,U,U,U,U,U,U,UU],
    [LL,L,L,L,L,L,L,L,L,L,L,L,L,L,L,L,U,U,U,L,L,U,U,U,U,U,U,U,U,U,U,U,UU],
    [LL,L,L,L,L,L,L,L,L,L,L,L,L,L,L,L,U,U,U,U,L,L,U,U,U,U,U,U,U,U,U,U,UU],
    [LL,L,L,L,L,L,L,L,L,L,L,L,L,L,L,L,U,U,U,U,U,L,L,U,U,U,U,U,U,U,U,U,UU],
    [LL,L,L,L,L,L,L,L,L,L,L,L,L,L,L,L,U,U,U,U,U,U,L,L,U,U,U,U,U,U,U,U,UU],
    [LL,L,L,L,L,L,L,L,L,L,L,L,L,L,L,L,l,l,U,U,U,U,U,U,U,U,U,U,U,U,U,U,UU],
    [LL,L,L,L,L,L,L,L,L,L,L,L,L,L,L,L,U,l,l,U,U,U,U,U,U,U,U,U,U,U,U,U,UU],
    [LL,L,L,L,L,L,L,L,L,L,L,L,L,L,L,L,U,U,l,l,U,U,U,U,U,U,U,U,U,U,U,U,UU],
    [LL,L,L,L,L,L,L,L,L,L,L,L,L,L,L,L,U,U,U,l,l,U,U,U,U,U,U,U,U,U,U,U,UU],
...
class Player:
    def __init__(self,movements,stepcount,partysize):
        self.x = 19
        self.y = 0
    ...
    def advance(self,rng):
        ...
        if self.tick < 1:
            ...
            if self.stepcount == 127:
                self.stepcount = 0
                rng.advance(self.partysize)
                self.rollover += 1
            else:
                self.stepcount += 1
        return [True,True]
...
for enter_frame in range(low, high):
    ...
    for movement_type in range(0,len(movements_to_try)):
        ...
        I = Player(movements_to_try[movement_type],stepcount,partysize)
        I.advance(primaryRNG)
        #print(f"{I.movements[I.cursor], {I.tick}, [{I.x},{I.y}]}")
        ...
        for x in range(0,len(NPCs)):
            if NPCs[x] != None:
                print(f"{x+1}: {NPCs[x].name} {NPCs[x].tick} [{NPCs[x].x}, {NPCs[x].y}]")
        '''
        ...
        while res[0]:
            '''
            print(f"{I.movements[I.cursor], {I.tick}, [{I.x},{I.y}, {I.rollover}]}")
            ...
            #res = I.advance(primaryRNG)
                ...
                if I.y > 6:
                    ...
                    if NPCs[5] != None:
                        if (not deloadCheck) and NPCs[5].chose_direction:
                            NPCs[5] = None
                        deloadCheck = True
        ...
        #DP advance rng by 4 after a battle
